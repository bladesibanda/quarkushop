...
import com.bladesibanda.domain.Product;
import com.bladesibanda.domain.enums.ProductStatus;
...
public class ProductService {
  ...
  public List<ProductDto> findAll() {
    ...
    return this.productRepository.findAll()
        .stream().map(ProductService::mapToDto).collect(Collectors.toList());
  }
  ...
  public List<ProductDto> findByCategoryId(Long id) {
    return this.productRepository.findByCategoryId(id).stream().map(ProductService::mapToDto)
